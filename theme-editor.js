...
function playQuestionnaire(id) {
    ...
    const delayMin = (typeof settings !== 'undefined' && settings.questionnaireViewMin) || 1500;
    const delayMax = (typeof settings !== 'undefined' && settings.questionnaireViewMax) || 2500;
